    ...
    <div className="auth-page glass-theme">
      <div className="auth-card-glass">
        ...
        <form onSubmit={handleSubmit} className="auth-form-glass">
          ...
          {isLogin && (
            <div className="auth-options-glass">
          ...
          <button type="button" className="btn-glass-social">
          ...
          <div className="auth-footer-glass">
            {isLogin ? (
              <p>Don't have an account? <span onClick={() => setIsLogin(false)}>Create Account</span></p>
            ) : (
